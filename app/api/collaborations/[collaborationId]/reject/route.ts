...
// PATCH /api/collaborations/[collaborationId]/reject - Reject invite
export async function PATCH(
  ...
  try {
    ...
    // Only the invited collaborator can reject
    ...
    console.error('Reject collaboration error:', err);
    return NextResponse.json({ error: err.message || 'Gagal menolak undangan' }, { status: 500 });
  }
}
